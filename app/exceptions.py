...
# =============================================================================
# EXCEÇÕES GENÉRICAS / DESCONHECIDAS PARA BANCO DE DADOS
# =============================================================================
...
class RetryableError(Exception):
    """Erro que pode ser resolvido com uma nova tentativa.

    Attributes:
        status_code (int): Código HTTP 503.
    """
    status_code = status.HTTP_503_SERVICE_UNAVAILABLE

class FatalError(Exception):
    """Erro crítico que não pode ser resolvido com uma nova tentativa.
